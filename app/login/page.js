    ...
    return (
        <div className='py-14 mx-auto container'>
            ...
            <div className="flex flex-col gap-2 min-h-screen items-center p-10">
                ...
                {/* <button
                    className="flex items-center bg-white justify-center w-68 border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
